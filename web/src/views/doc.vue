<template>
  <a-layout>
    <a-layout-content :style="{ background: '#fff', padding: '24px', margin: 0, minHeight: '280px' }">
      <h3 v-if="level1.length === 0">Sorry, no relevant documentation found!</h3>
      <a-row>
        <a-col :span="6">
          <a-tree
...
<style>
/* wangeditor default style, refer to: http://www.wangeditor.com/doc/pages/02-%E5%86%85%E5%AE%B9%E5%A4%84%E7%90%86/03-%E8%8E%B7%E5%8F%96html.html */
/* table 样式 */
.wangeditor table {
...
/* Conflicts with antdv p, overwrites */
